...

{
  ...
  wayland.windowManager.hyprland.settings = {
    ...
    bind = [
      ...
      "$mod_CTRL_ALT, 1, exec, hyprctl keyword monitor \"DP-1, 3440x1440@144.00, 0x0, 1, bitdepth, 10, vrr, 3\" && hyprctl keyword monitor \"HDMI-A-1, disable\""
      "$mod_CTRL_ALT, 2, exec, hyprctl keyword monitor \"HDMI-A-1, 3840x2160@120.00, 0x0, bitdepth, 10, vrr, 3\" && hyprctl keyword monitor \"DP-1, disable\""
