...

{
  ...
  wayland.windowManager.hyprland.settings = {
    ...
    bind = [
      ...
      "$mod, F6, exec, hyprctl keyword monitor \"DP-1, 3440x1440@144.00, 0x0, 1, bitdepth, 10, vrr, 3, cm, hdr, sdrbrightness, 1.3, sdrsaturation, 1\""
      "$mod, F1, exec, hyprctl keyword monitor \"DP-1, 3440x1440@144.00, 3840x0, 1, vrr, 3, bitdepth, 10\" && hyprctl keyword monitor \"HDMI-A-1, disable\""
      "$mod, F2, exec, hyprctl keyword monitor \"HDMI-A-1, 3840x2160@120.00, 3440x0, 1, vrr, 3\" && hyprctl keyword monitor \"DP-1, disable\""
