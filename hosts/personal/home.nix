...

{
  ...
  wayland.windowManager.hyprland.settings = {
    ...
    bind = [
      ...
      "$mod_CTRL_ALT, H, exec, hyprctl keyword monitor \"DP-1, 3440x1440@144.00, 0x0, 1, bitdepth, 10, vrr, 3, cm, hdr, sdrbrightness, 1.3, sdrsaturation, 1, sdr_min_luminance, 0.005\""
      "$mod_CTRL_ALT, S, exec, hyprctl keyword monitor \"DP-1, 3440x1440@144.00, 0x0, 1, bitdepth, 10, vrr, 3,\""
    ];
  };
}
